...
"<div class='col-s-12 col-l-12'>Willkommen auf pr0.tools!</div>".PHP_EOL.
"<div class='col-s-12 col-l-12'>pr0.tools ist eine Linksammlung für nützliche Tools rund ums pr0gramm.</div>".PHP_EOL.
...
"<div class='col-s-12 col-l-12'>Dir fehlt eine Verlinkung? <a href='https://pr0gramm.com/inbox/messages/RundesBalli' target='_blank' rel='noopener'>Schreib mir eine PN</a> oder <a href='https://github.com/RundesBalli/pr0tools/issues/new' target='_blank' rel='noopener'>eröffne ein Issue auf Github</a>.</div>".PHP_EOL.
"</div>".PHP_EOL;
...
$content.= "<div class='col-s-12 col-l-3'><a href='/all'>Alles</a></div>".PHP_EOL.
"<div class='col-s-12 col-l-9'>Zeigt alle Inhalte an.</div>".PHP_EOL.
...
while($row = mysqli_fetch_array($result)) {
  $content.= "<div class='row hover'>".PHP_EOL;
  $content.= "<div class='col-s-12 col-l-3'><a href='/category/".$row['shortTitle']."'>".$row['title']."</a></div>".PHP_EOL.
  "<div class='col-s-12 col-l-9'>".($row['shortDescription'] == NULL ? "<span class='italic'>Keine Beschreibung vorhanden</span>" : $row['shortDescription'])."</div>".PHP_EOL.
  "<div class='col-s-12 col-l-0'><div class='spacer-s'></div></div>".PHP_EOL;
  $content.= "</div>".PHP_EOL;
}
?>
